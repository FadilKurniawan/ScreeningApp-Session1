...
class EventActivity : AppCompatActivity() ,AdapterView.OnItemClickListener{
    ...
    private fun initialization() {
        ...
        eventList.add(Event("Pekan #KreatifDisaatSulit","4 April 2020",R.drawable.event1))
        eventList.add(Event("Saturasi Volume 1","4 April 2020",R.drawable.event3))
        eventList.add(Event("Charity Selection Night","3 April 2020",R.drawable.event2))
        eventList.add(Event("ANGKLUNG MUSIC CONCERT","20 March 2020",R.drawable.event4))
